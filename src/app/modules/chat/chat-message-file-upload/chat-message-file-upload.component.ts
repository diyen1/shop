...
@Component({
  selector: 'app-chat-messaged-file-upload',
  templateUrl: './chat-message-file-upload.component.html',
  styleUrls: ['./chat-message-file-upload.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ChatMessageFileUploadComponent),
      multi: true,
    },
  ],
})
export class ChatMessageFileUploadComponent implements OnInit, ControlValueAccessor {
